...
class TestState_instantiation(unittest.TestCase):
    ...
    def test_no_args_instantiates(self):
        """Test for State instantiation with no args
        """
        self.assertEqual(State, type(State()))

    def test_new_instance_stored_in_objects(self):
        """Test for State instance in stored objects dict
        """
    ...
    def test_two_states_different_updated_at(self):
        """Test for two State instances' updated_at atttibute value
        """
        st1 = State()
        sleep(0.05)
        st2 = State()
    ...
    def test_args_unused(self):
        """Test for State instantiation with unused args
        """
        st = State(None)
        self.assertNotIn(None, st.__dict__.values())

    def test_instantiation_with_kwargs(self):
        """Test for State instantiation with kwargs
        """
        dt = datetime.today()
        dt_iso = dt.isoformat()
    ...
    def test_instantiation_with_None_kwargs(self):
        """Test for State instantiation with none kwargs
        """
