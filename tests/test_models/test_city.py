...
class TestCity_instantiation(unittest.TestCase):
    ...
    def test_state_id_is_public_class_attribute(self):
        """Test for state_id attribute type
        """
        cy = City()
    ...
    def test_two_cities_unique_ids(self):
        """Test for two city instances' ids
        """
        cy1 = City()
        cy2 = City()
    ...
    def test_two_cities_different_created_at(self):
        """Test for two city instances created at different time
        """
        cy1 = City()
        sleep(0.05)
        cy2 = City()
    ...
    def test_two_cities_different_updated_at(self):
        """Test for two city instances' updated_at atttibute value
        """
        cy1 = City()
        sleep(0.05)
        cy2 = City()
